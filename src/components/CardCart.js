      ...
      <div className="w-5/6 md:w-4/6 lg:w-3/6 mx-auto mt-6">
        <div className="px-3 py-5 rounded-md bg-white flex justify-center">
          ...
          <div className="w-1/2 text-left relative">
            ...
            <div className="flex flex-col sm:flex-row space-x-0 sm:space-x-20">
              <div className="flex flex-col min-[425px]:flex-row">
                ...
                {/* responsive delete product cart */}
                <button
                  onClick={deleteClick}
                  className="rounded-md bg-[#cf6137] text-white text-xs font-medium px-1 h-8 w-7 block sm:hidden ml-auto"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
              ...
              <div className="text-darkgreen text-base font-bold mb-5 order-first sm:order-none">
                ${price}
              </div>
            </div>
